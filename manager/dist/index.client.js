...
import { createTokensTable } from './tokens/table.js';
import { createTokensLibraryTable } from './tokens/library.js';
import { createProjectsTable, createDefaultProject } from './projects/index.js';
...
export const dialect = new Kysely({
	dialect: new PgliteDialect({
		// PGliteWorker implements the same interface as PGlite,
		// so the dialect can use it seamlessly.
		database: pgWorker
	})
});
