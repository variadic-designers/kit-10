...
export const createDirectoriesTable = async (db) => {
    await db.schema
        ...
        .addCheckConstraint('no_parent_no_index_vice_versa', sql `(parent_id IS NULL) = (parent_index IS NULL)`)
        // Ensure uniqueness within the same parent
        .addUniqueConstraint('unique_index_in_parent', ['parent_id', 'parent_index'], (cb) => cb.nullsNotDistinct())
...
export const createDirectoryTriggerForTable = (tableName, options = {}) => {
