...
export const resolveAllTokens = async (db: Kysely<Kit10Project>) => {
...
export const getTokensWithDeps = async (db: Kysely<Kit10Project>) => {
	return await db
...
export const getDependencyGraph = async (db: Kysely<Kit10Project>, tokenName: string) => {
