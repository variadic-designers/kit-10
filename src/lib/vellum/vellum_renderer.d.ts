...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9302: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9302_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9302_3: (a: number, b: number, c: number, d: number) => void;
