...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_8852: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_8854: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_7448: (a: number, b: number, c: number) => void;
