...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9569: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_8116: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_8116_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_8116_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9571: (a: number, b: number, c: number, d: number) => void;
