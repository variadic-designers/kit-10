...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9304: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9304_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9304_3: (a: number, b: number, c: number, d: number) => void;
