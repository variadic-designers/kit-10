...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_9129: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_7676: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_7676_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_7676_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9131: (a: number, b: number, c: number, d: number) => void;
